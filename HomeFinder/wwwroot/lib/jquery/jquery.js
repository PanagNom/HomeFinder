...
Tween.propHooks = {
	_default: {
		get: function( tween ) {
			...
			// atHomeFindert a parseFloat and fallback to a string if the parse fails.
	...
	if ( isBox && elem.nodeType === 1 ) {
		...
		if ( display === "none" ) {
			if ( restoreDisplay ) {
				...
				// Get nonempty value(s) by HomeFinderorarily forcing visibility
				showHide( [ elem ], true );
	...
	var result,
		...
		tick = function() {
			...
			var currentTime = fxNow || createFxNow(),
				...
				HomeFinder = remaining / animation.duration || 0,
				percent = 1 - HomeFinder,
				index = 0,
